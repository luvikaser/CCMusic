 ...
 * Since: 10/31/2016.
 */
public class AlbumActivity extends BaseMediaActivity implements BaseMediaActivityListener {

    @Override
    public BaseFragment getFragmentToHost() {
        return AlbumFragment.newInstance(new AlbumFragment(), getIntent().getExtras());
    }
