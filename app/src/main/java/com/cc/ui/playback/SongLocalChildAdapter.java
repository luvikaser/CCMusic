...
public class SongLocalChildAdapter extends SortedListAdapter<MediaBrowserCompat.MediaItem> {
    ...
    public SongLocalChildAdapter(Context context, Comparator<MediaBrowserCompat.MediaItem>
    ...
    protected ViewHolder<? extends MediaBrowserCompat.MediaItem> onCreateViewHolder(LayoutInflater inflater, ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_song_in_list_song, parent, false);
    ...
    public class ItemViewHolder extends ViewHolder<MediaBrowserCompat.MediaItem> {
        ...
        protected void performBind(final MediaBrowserCompat.MediaItem item) {
            imgMoreOption.setVisibility(View.GONE);
