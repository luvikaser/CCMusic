 ...
 */
public class VMSongVirtualCalifornialTable {
    private static final String TAG = VMSongVirtualCalifornialTable.class.getSimpleName();

    public static final String TABLE_NAME = "ZSONGVIRTUAL_CALIFORNIA";
    ...
    public static String QUERY_CREATE_TABLE =
            "CREATE VIRTUAL TABLE `ZSONGVIRTUAL_CALIFORNIA` USING FTS3 ( "
