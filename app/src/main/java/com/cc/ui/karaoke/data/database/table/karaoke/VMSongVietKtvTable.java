 ...
 */
public class VMSongVietKtvTable extends VMBaseTable {

    public static final String TABLE_NAME =  "ZSONG_VIETKTV";
    ...
    private static VMSongVietKtvTable instance = null;

    public static VMSongVietKtvTable getInstance() {
        if (instance == null) {
            instance = new VMSongVietKtvTable();
        }
