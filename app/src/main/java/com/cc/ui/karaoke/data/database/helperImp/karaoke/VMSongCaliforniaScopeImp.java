 ...
 */
public class VMSongCaliforniaScopeImp extends VMBaseSongKaraokeScopeImp implements VMSongKaraokeScope {
    ...
    public Cursor getCursor() {
        ...
        Cursor cursor = cr.query(VMSongCaliforniaTable.getInstance().getContentUri(), null, selection, selectionArg,
                sortOrder);
    ...
    public Cursor searchQuery(String key, String volId) {
        String selection = String.format(VMSongVirtualCalifornialTable.SELECTION_SEARCH,
        ...
        Cursor cursor = contentResolver.query(VMSongCaliforniaTable.getInstance().getContentUri(),
    ...
    public Cursor getCursorWithVolsName(String volsName, String language) {
        ...
        ContentResolver cr = MusicApplication.getInstance().getApplicationContext().getContentResolver();
        Cursor cursor = cr.query(VMSongCaliforniaTable.getInstance().getContentUri(),
                null, selection, selectionArg, sortOrder);
        if (cursor != null && cursor.moveToFirst()) {
            return cursor;
        }
