 ...
 */
public class VMSongVirtualVietKtvTable {
    private static final String TAG = VMSongVirtualVietKtvTable.class.getSimpleName();

    public static final String TABLE_NAME = "ZSONGVIRTUAL_VIETKTV";
    ...
    public static String QUERY_CREATE_TABLE =
            "CREATE VIRTUAL TABLE `ZSONGVIRTUAL_VIETKTV` USING FTS3 ( "
