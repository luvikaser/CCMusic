...
public class DonutProgress extends View {
    ...
    private final int default_finished_color = Color.rgb(255, 255, 0);
    ...
    private static final String INSTANCE_SIZE = "size";
    ...
    public DonutProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = UtilsProgress.sp2px(getResources(), 20);
        min_size = (int) UtilsProgress.dp2px(getResources(), 80);
        default_stroke_width = UtilsProgress.dp2px(getResources(), 3);
        default_inner_bottom_text_size = UtilsProgress.sp2px(getResources(), 18);
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        setProgress(attributes.getInt(R.styleable.DonutProgress_donut_progress, 0));
         finishedStrokeWidth = attributes.getDimension(R.styleable
                 .DonutProgress_donut_finished_stroke_width, default_stroke_width);
    ...
    public void setSizeDonut(int size) {
        this.min_size = size;
        invalidate();
    }

    public int getSizeDonut() {
        return min_size;
    }
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        bundle.putInt(INSTANCE_SIZE, getSizeDonut());
