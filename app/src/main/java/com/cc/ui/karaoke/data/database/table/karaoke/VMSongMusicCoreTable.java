 ...
 */
public class VMSongMusicCoreTable extends VMBaseTable {

    public static final String TABLE_NAME =  "ZSONG_MUSICCORE";
    ...
    private static VMSongMusicCoreTable instance = null;

    public static VMSongMusicCoreTable getInstance() {
        if (instance == null) {
            instance = new VMSongMusicCoreTable();
        }
