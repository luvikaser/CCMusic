 ...
 */
public class VMSongVirtualCoreMusicTable {
    private static final String TAG = VMSongVirtualCoreMusicTable.class.getSimpleName();

    public static final String TABLE_NAME = "ZSONGVIRTUAL_MUSICCORE";
    ...
    public static String QUERY_CREATE_TABLE =
            "CREATE VIRTUAL TABLE `ZSONGVIRTUAL_MUSICCORE` USING FTS3 ( "
