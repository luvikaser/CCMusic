 ...
 */
public class VMSongArirangTable extends VMBaseTable {

    public static final String TABLE_NAME =  "ZSONG_ARIRANG";
    ...
    private static VMSongArirangTable instance = null;

    public static VMSongArirangTable getInstance() {
        if (instance == null) {
            instance = new VMSongArirangTable();
        }
