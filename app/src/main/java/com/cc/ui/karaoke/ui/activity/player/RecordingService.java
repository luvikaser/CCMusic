...
/**
 * PlayerYoutubeActivity more likly to be removed from memory when paused then service. Notification button
...
public class RecordingService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            ...
            if (a == null) {
                ...
                Intent i = new Intent(PlayerYoutubeActivity.PAUSE_BUTTON);
                sendBroadcast(i);
            } else if (a.equals(SHOW_ACTIVITY)) {
                PlayerYoutubeActivity.startActivity(this, false);
            }
        }
    ...
    public void showNotificationAlarm(boolean show) {
        ...
        if (!show) {
            ...
            RemoteViews view = new RemoteViews(getPackageName(), MusicApplication.getTheme
                    (getBaseContext(),
