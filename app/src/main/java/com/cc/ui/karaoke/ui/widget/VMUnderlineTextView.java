package com.cc.ui.karaoke.ui.widget;
 ...
 */
public class VMUnderlineTextView extends TextView{
    private Paint mLinePaint;

    private int mSpaceHeight;

    public VMUnderlineTextView(Context context) {
        super(context);
        init(context);
    }

    public VMUnderlineTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public VMUnderlineTextView(Context context, AttributeSet attrs, int defStyle) {
