 ...
 */
public class VMSongFavoriteTable extends VMBaseTable {
    ...
    public static String QUERY_CREATE_TABLE = "CREATE TABLE `SONGFAVORITE` (\n" +
            "\t`Z_PK`\tINTEGER,\n" +
            "\t`Z_ENT`\tINTEGER,\n" +
            "\t`Z_OPT`\tINTEGER,\n" +
            "\t`ZROWID`\tINTEGER,\n" +
    ...
    private static VMSongFavoriteTable instance = null;

    public static VMSongFavoriteTable getInstance() {
        if (instance == null) {
            instance = new VMSongFavoriteTable();
        }
     ...
     * create table
     *
     * @param db used to get database object for crate tableZISFAVORITE
     */
    @Override
