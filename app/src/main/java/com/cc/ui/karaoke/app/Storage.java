...
public class Storage {
    ...
    public File getStoragePath() {
        ...
        String path = shared.getString(MusicApplication.PREFERENCE_STORAGE, "");
...
//        return getNextFile(parent, fileName + "-" + s.format(new Date()), ext);
        return getNextFile(parent, fileName, ext);
