...
import com.cc.provider.music.MusicProviderSource;
...
public class LocalPlayback implements Playback, AudioManager.OnAudioFocusChangeListener,
    ...
    public PresetReverb mPresentReverb;
    ...
    public void play(QueueItem item) {
        ...
        if (mState == PlaybackStateCompat.STATE_PAUSED && !mediaHasChanged && mMediaPlayer != null) {
            ...
            /*--------START CHECK SONG AND SAVE SONG-------------------------*/

            //TODO: SAVE song played
            /*
            if (track != null) {

                MediaLocalItem mediaLocalItem = new MediaLocalItem(track);
                try {
                    if (!MusicApplication.getInstance().getUserComponent()
                            .songLocalPlayedRepository().isExistSong(mediaLocalItem)) {
                        Log.e(TAG, "save new song played  = " + track.getDescription().toString());
    ...
    private void createMediaPlayerIfNeeded() {
        ...
        if (mMediaPlayer == null) {
            ...
            mPresentReverb = new PresetReverb(0, mMediaPlayer.getAudioSessionId());
            mPresentReverb.setEnabled(true);
